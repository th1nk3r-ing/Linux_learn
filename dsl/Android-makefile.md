...
> `@think3r` 2018-04-28 16:04:41

## <font color=#009A000> 参考链接: </font>

- [linux和Android的Makefile和`Android.mk`](https://www.cnblogs.com/maogefff/p/7910441.html#_label1)
...
- `Android.mk` 是一个向 Android NDK 构建系统描述 NDK 项目的 GUN Makefile 片段。它是每一个 NDK 项目的必备组件。构建系统希望它出现在 jni 子目录中。
